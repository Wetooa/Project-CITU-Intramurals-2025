...
export function GameResultCardContainer({
  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md border-gray-800 bg-eerie_black text-gray-200">
      ...
      <CardContent className="p-4">
        <div className="grid grid-cols-7 items-center gap-2 py-2">
          ...
          <div className="col-span-1 flex justify-center">
            <div className="flex items-center justify-center rounded-md bg-gray-800 px-3 text-center py-1 text-sm font-bold ">
              {status === "Scheduled" ? (
                "vs"
              ) : (
                <>
        ...
        <div className="grid grid-cols-1 gap-2 text-sm text-gray-400  sm:flex sm:items-center sm:justify-between sm:px-4">
