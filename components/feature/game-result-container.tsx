...
export function GameResultCardContainer({
  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md border-maroon bg-eerie_black text-gray-200">
      ...
      <CardContent className="p-4">
        <div className="grid grid-cols-7 items-center gap-2 py-2">
          ...
          <div className="col-span-1 flex justify-center">
            <div className="flex items-center justify-center rounded-md bg-maroon px-3 text-center py-1 text-sm font-bold ">
              {status === "Scheduled" ? (
                "vs"
              ) : (
                <>
