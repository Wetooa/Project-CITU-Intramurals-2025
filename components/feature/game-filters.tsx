    ...
    const getFilterLabel = (key: string, value: string) => {
        switch (key) {
            ...
            case "matchDate":
                ...
                const dateLabel = Object.entries(MATCH_DATES).find(([_, val]) => val === value)?.[0] || value
        ...
        <div className="w-full">
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <Card
                            className="overflow-hidden border-maroon bg-gradient-to-br from-mocha to-[#1a1512] shadow-xl mb-6">
