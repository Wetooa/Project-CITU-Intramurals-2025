        ...
        <div className="w-full h-28 bg-[#302F2E] rounded-md border-white border border-opacity-5 flex flex-col">
          ...
          <span className="md:text-2xl text-md font-bold align-middle text-left">
            {schedule.matchTime}
                ...
                <div
                    className="md:col-span-5 col-start-4 col-span-3 grid-cols-3 grid md:grid-cols-5 md:col-start-2 items-center justify-around w-full h-full">
            ...
            <span
                className="md:text-lg text-xs col-start-4 md:col-start-3 items-center text-[#CCCCCC] font-bold text-opacity-25">
              <span
                  className={
