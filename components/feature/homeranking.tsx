    ...
    <div className="md:flex flex-col w-1/5 h-full hidden">
      <div className="bg-[#242322] rounded-lg p-6 shadow-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-center p-4 bg-[#302F2E] rounded-lg border-l-4 border-yellow-500 transition-transform duration-300 hover:translate-x-1">
            <div className="mr-3">
              <Trophy className="h-5 w-5 text-yellow-500" />
            </div>
          ...
          <div className="flex items-center p-4 bg-[#302F2E] rounded-lg border-l-4 border-gray-400 transition-transform duration-300 hover:translate-x-1">
            <div className="mr-3">
          ...
          <div className="flex items-center p-4 bg-[#302F2E] rounded-lg border-l-4 border-amber-700 transition-transform duration-300 hover:translate-x-1">
            <div className="mr-3">
