            ...
            <div className="flex flex-col text-white gap-3 mb-10 text-center mt-40 px-10">
                ...
                <div className="flex w-full flex-row lg:gap-5 lg:px-10 h-fit">
                    <div className="lg:flex flex-col w-1/4 gap-5 items-start pl-10 hidden">
                        ...
                        <p className="text-5xl lg:text-3xl xl:text-5xl font-bold pl-4 mt-7">SPORTS</p>
                        ...
                        <div className="flex flex-col gap-2 items-start">
                            {Sports.map((sport) => (
                                <Button
                                    ...
                                    key={sport.value}
                                    value={sport.value}
                                    className={`xl:text-2xl md:text-xl  font-bold ${
                        ...
                        <p className="text-5xl lg:text-3xl xl:text-5xl font-bold pl-4 mt-7">ESPORTS</p>
                        <div className="flex flex-col gap-2 items-start">
                            {Esports.map((sport) => (
                                <Button
                                    variant="link"
