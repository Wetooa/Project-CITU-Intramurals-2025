    ...
    return (
        <div className="flex md:pl-12 md:pr-12 pl-6 pr-6 gap-6 w-full h-screen ">
            ...
            <div className="flex flex-col md:w-1/2 w-full gap-4 h-full">
                <div
                    className="bg-[#242322] rounded-br-lg rounded-bl-lg w-full flex gap-2 justify-between items-center md:p-6 p-2 h-32">
          <span className="hidden md:block md:text-5xl text-md font-bold">
            MATCH TODAY
                    ...
                    <Select defaultValue="MEN" onValueChange={setFilter}>
                        <SelectTrigger
                            className="border-0 bg-[#302F2E] h-16 md:w-48 w-1/3 md:text-xl text-sm md:hidden font-bold">
                            <SelectValue/>
                        </SelectTrigger>
                    ...
                    <Select defaultValue="BASKETBALL" onValueChange={setSelectedCategory}>
                        <SelectTrigger
                            className="border-0 bg-[#302F2E] h-16 md:w-48 w-1/3 md:text-xl md:hidden text-sm font-bold">
                            <SelectValue/>
                        </SelectTrigger>
                        <SelectContent className="bg-[#582424] font-bold text-lg text-white">
                            <SelectGroup>
                    ...
                    <Select defaultValue="ONGOING" onValueChange={setFilter}>
                        <SelectTrigger
                            className="border-0 bg-[#302F2E] h-16 md:w-48 w-1/3  md:text-xl text-sm  font-bold">
                            <SelectValue/>
                        </SelectTrigger>
                        <SelectContent className="bg-[#582424] font-bold text-lg text-white">
                            <SelectGroup>
