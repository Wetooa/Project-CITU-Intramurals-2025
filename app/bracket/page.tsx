...
import {GAMES, teamLogos, TEAMS} from "@/types/constant";
...
export default function BracketScreen() {
    ...
    return (
        <div className="flex items-center pl-12 pr-12 md:flex-row flex-col gap-6 md:gap-0 h-screen w-full ">
            ...
            <div
                className="h-screen w-[400px] md:flex  p-6  pl-10  justify-start bg-phantom_ash flex-col hidden mb-6 mt-6 overflow-y-auto">
                <p className="2xl:text-6xl font-bold self-start md:text-xl lg:text-3xl">BRACKET</p>
        ...
        <div className="w-max  h-full overflow-x-auto overflow-y-auto gap-5 flex flex-nowrap pl-12 pr-12">
            {matches.rounds.map((round, index) => (
                <div className="flex flex-col w-fit h-full gap-5">
                    ...
                    <div
                        className="w-[300px] md:h-[1000px] h-[500px] md:gap-16 gap-8 flex items-center justify-center flex-col">
