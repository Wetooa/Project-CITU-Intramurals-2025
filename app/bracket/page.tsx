    ...
    return (
        <>
            <div className="flex items-center justify-start mt-10 md:mt-0">
                ...
                <div className="h-screen w-[400px] z-50 flex p-5 pl-10 justify-start bg-phantom_ash flex-col">
                    ...
                    <div className="mt-5 flex flex-col gap-2">
                        {GAMES.slice(0, 7).map((game: string, index: number) => (
                            <p
                                key={index}
                                className={`text-xl cursor-pointer font-bold transition-all ${
                                    selectBracket === game.toUpperCase()
